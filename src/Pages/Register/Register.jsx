...
const Register = () => {
    ...
    const { createUser, googleSignIn, setUsers, userProfile } = use(AuthContext)
    ...
    const handleRegister = (e) => {
        ...
        // send data firebase for email sign up
                ...
                userProfile(name, photo)
                    .then(() => {
                        Swal.fire({
                            position: "center",
                            icon: "success",
                            title: "Congratulation! Your Registration completed",
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleRegister}>
                        ...
                        <label className="label pt-2">Photo</label>
                        ...
                        <input className="btn btn-neutral mt-4 w-full" type="submit" value="Register" />
                    ...
                    <div><h3>Already have an account? Please <NavLink to='/login'><span className='text-blue-400'>Login</span></NavLink></h3></div>
                </div>
            </div>
        </div>
    );
